...
Analysis scripts: [`../analysis/pipeline/runVariantAnalysis.m`](../analysis/pipeline/runVariantAnalysis.m) (roll-up and SR-gate compliance), [`../analysis/pipeline/runTradeStudy.m`](../analysis/pipeline/runTradeStudy.m) (MCDA scoring and Monte Carlo sensitivity), plus helpers [`gsRollup.m`](../analysis/utils/gsRollup.m), [`gsCollectLeaves.m`](../analysis/utils/gsCollectLeaves.m), [`gsParseBudgetValue.m`](../analysis/utils/gsParseBudgetValue.m). Outputs: [`../analysis/results/variantMetrics.csv`](../analysis/results/variantMetrics.csv), [`../analysis/results/tradeScores.csv`](../analysis/results/tradeScores.csv), [`../analysis/results/mcWinShare.csv`](../analysis/results/mcWinShare.csv), and the figures in [`figures/`](figures/). When the formal gate later narrows the candidate set, the compliant-only rerun is written separately as tagged artifacts such as `tradeScores_compliant.csv` and [`figures/compliant/`](figures/compliant/), so the published comparison figures are not overwritten. Results are presented in [`06_trade_study_results.md`](06_trade_study_results.md).
