...
|---|---|---|
| [01_static_rollup.md](01_static_rollup.md) | What does each architecture claim on its datasheet? | HyperCook is already over its cost and volume caps on paper; the other two fit. |
...
| [04_compliance_gate.md](04_compliance_gate.md) | Which variants actually qualify? | 21 of 24 checks pass — only EverSimmer clears all eight. |
| [05_trade_scoring.md](05_trade_scoring.md) | Weighing everything at once, which architecture comes out ahead? | EverSimmer wins three of four scenarios and 85.2% of random weightings; LeanBroth takes CostLean. |
